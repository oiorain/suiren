...
export interface ApiWordWord extends Schema.CollectionType {
  ...
  attributes: {
    kanji: Attribute.String & Attribute.Required;
    hiragana: Attribute.String;
    english: Attribute.Text;
    jlpt: Attribute.Integer;
    wanikani: Attribute.Integer;
    isCommon: Attribute.Boolean;
