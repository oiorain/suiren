...
export interface ApiWordWord extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    kanji: Schema.Attribute.String & Schema.Attribute.Required;
    hiragana: Schema.Attribute.String;
    english: Schema.Attribute.Text;
    jlpt: Schema.Attribute.Integer;
    wanikani: Schema.Attribute.Integer;
    isCommon: Schema.Attribute.Boolean;
